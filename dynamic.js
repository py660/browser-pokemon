...
let browserPokemon = {};
function doBrowserPokemon(image){
    for (let i=0;i<5;i++){
        try{
            function uuidv4() {
...
/*
javascript: (function(){let URL="https://static.wikia.nocookie.net/cookieclicker/images/5/50/GoldCookie.png/revision/latest?cb=20230401175923"; if (window.trustedTypes && window.trustedTypes.createPolicy && !Object.keys(window.trustedTypes)) {window.trustedTypes.createPolicy('default', {createHTML: (string) => string,createScriptURL: string => string,createScript: string => string,});} if (typeof doBrowserPokemon == "function"){doBrowserPokemon(URL);}else{var jsCode = document.createElement('script');jsCode.setAttribute('src', 'https://py660.github.io/browser-pokemon/dynamic.js?cache='+(new Date()).toString());document.body.appendChild(jsCode);var listener = document.addEventListener("securitypolicyviolation", (e) => {if (e.blockedURI.startsWith("https://py660.github.io/browser-pokemon/index.js")){alert("Script blocked by CSP. Please try again on another website.");document.removeEventListener("securitypolicyviolation", listener);}});jsCode.onload = ()=>{alert("Installing customized browser pokemon...");doBrowserPokemon(URL);}}}())
*/